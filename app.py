...
/* Header Streamlit: trasparente, manteniamo hamburger */
...
/* Mobile: sposto la top bar un filo più giù e riduco font */
...
st.markdown(
    ...
    <div class="bs-top-bar">
        ...
        <div class="bs-top-right-text">
            ...
            <div class="bs-top-badge">Concept demo</div>
        </div>
    </div>
    """,
...
# Logout e descrizione
left_logout, right_logout = st.columns([0.85, 0.15])
with right_logout:
